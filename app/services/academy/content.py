...
class ContentServices(
    ...
    def get_by_detail(
        ...
        for content_category in content_categories:
            categories.append(
                db.query(models.academy.Category)
                .filter(models.academy.Category.id == content_category.category_id)
                .first()
            )
        labels = []
        for content_label in content_labels:
            labels.append(
                db.query(models.academy.Label)
                .filter(models.academy.Label.id == content_label.label_id)
                .first()
            )
