...
Revision ID: cf0fb9c8dc9c
Revises:
Create Date: 2023-05-24 12:05:20.261737
...
def upgrade():
    ...
    op.create_index(
        op.f("ix_credit_plan_features_id"), "credit_plan_features", ["id"], unique=False
    )
    op.create_table(
        "users",
    ...
    op.create_index(
        op.f("ix_bot_builder_chatflows_id"),
        "bot_builder_chatflows",
        ["id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_bot_builder_chatflows_user_id"),
        "bot_builder_chatflows",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_connections_account_id"), "connections", ["account_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_credit_credits_id"), "credit_credits", ["id"], unique=False
    )
    op.create_table(
        "credit_invoices",
        sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    op.create_index(
        op.f("ix_credit_invoices_id"), "credit_invoices", ["id"], unique=False
    )
    op.create_table(
        "instagram_pages",
        sa.Column(
    ...
    op.create_index(
        op.f("ix_instagram_pages_id"), "instagram_pages", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_live_chat_contacts_contact_igs_id"),
        "live_chat_contacts",
        ["contact_igs_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_live_chat_contacts_facebook_page_id"),
        "live_chat_contacts",
        ["facebook_page_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_live_chat_contacts_id"), "live_chat_contacts", ["id"], unique=False
    )
    op.create_table(
        "live_chat_messages",
    ...
    op.create_index(
        op.f("ix_live_chat_messages_id"), "live_chat_messages", ["id"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_notification_users_id"), "notification_users", ["id"], unique=False
    )
    op.create_table(
        "notifier_campaigns",
        sa.Column("name", sa.String(length=255), nullable=True),
    ...
    op.create_index(
        op.f("ix_notifier_campaigns_facebook_page_id"),
        "notifier_campaigns",
        ["facebook_page_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notifier_campaigns_id"), "notifier_campaigns", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_notifier_campaigns_user_id"),
        "notifier_campaigns",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_notifier_groups_facebook_page_id"),
        "notifier_groups",
        ["facebook_page_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notifier_groups_id"), "notifier_groups", ["id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_bot_builder_edges_chatflow_id"),
        "bot_builder_edges",
        ["chatflow_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_bot_builder_edges_id"), "bot_builder_edges", ["id"], unique=False
    )
    op.create_table(
        "bot_builder_nodes",
        sa.Column("title", sa.String(length=255), nullable=True),
    ...
    op.create_index(
        op.f("ix_bot_builder_nodes_chatflow_id"),
        "bot_builder_nodes",
        ["chatflow_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_bot_builder_nodes_id"), "bot_builder_nodes", ["id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_bot_builder_nodeuies_chatflow_id"),
        "bot_builder_nodeuies",
        ["chatflow_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_bot_builder_nodeuies_id"), "bot_builder_nodeuies", ["id"], unique=False
    )
    op.create_table(
        "credit_credit_logs",
        sa.Column("module", sa.String(length=20), nullable=False),
    ...
    op.create_index(
        op.f("ix_credit_credit_logs_id"), "credit_credit_logs", ["id"], unique=False
    )
    op.create_table(
        "notifier_campaign_contacts",
        sa.Column("contact_igs_id", sa.BigInteger(), nullable=True),
    ...
    op.create_index(
        op.f("ix_notifier_campaign_contacts_campaign_id"),
        "notifier_campaign_contacts",
        ["campaign_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notifier_campaign_contacts_id"),
        "notifier_campaign_contacts",
        ["id"],
        unique=False,
    )
    op.create_table(
        "notifier_group_contacts",
        sa.Column("contact_igs_id", sa.BigInteger(), nullable=True),
        sa.Column("contact_id", sa.BigInteger(), nullable=True),
    ...
    op.create_index(
        op.f("ix_notifier_group_contacts_group_id"),
        "notifier_group_contacts",
        ["group_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_notifier_group_contacts_id"),
        "notifier_group_contacts",
        ["id"],
        unique=False,
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_notifier_group_contacts_id"), table_name="notifier_group_contacts"
    )
    op.drop_index(
        op.f("ix_notifier_group_contacts_group_id"),
        table_name="notifier_group_contacts",
    )
    op.drop_table("notifier_group_contacts")
    op.drop_index(
        op.f("ix_notifier_campaign_contacts_id"),
        table_name="notifier_campaign_contacts",
    )
    op.drop_index(
        op.f("ix_notifier_campaign_contacts_campaign_id"),
        table_name="notifier_campaign_contacts",
    ...
    op.drop_index(
        op.f("ix_notifier_groups_facebook_page_id"), table_name="notifier_groups"
    )
    op.drop_table("notifier_groups")
    op.drop_index(
        op.f("ix_notifier_campaigns_user_id"), table_name="notifier_campaigns"
    )
    op.drop_index(op.f("ix_notifier_campaigns_id"), table_name="notifier_campaigns")
    op.drop_index(
        op.f("ix_notifier_campaigns_facebook_page_id"), table_name="notifier_campaigns"
    )
    ...
    op.drop_index(
        op.f("ix_live_chat_contacts_facebook_page_id"), table_name="live_chat_contacts"
    )
    op.drop_index(
        op.f("ix_live_chat_contacts_contact_igs_id"), table_name="live_chat_contacts"
    )
    ...
    op.drop_index(
        op.f("ix_bot_builder_chatflows_user_id"), table_name="bot_builder_chatflows"
    )
    op.drop_index(
        op.f("ix_bot_builder_chatflows_id"), table_name="bot_builder_chatflows"
    )
